    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td><el-button @click="createCustomerPlan()">保存</el-button></td>
            </tr>
...
export default {
    ...
    mounted() {
        httpRequest.get('/saleservice/customerPlan/pageCP', {
    ...
    methods: {
        ...
        updateCatche(item) {
            httpRequest.post('/saleservice/customerPlan/updateCatche', {
                clientId: this.client.clientId,
                id: item.id,
                ...
                .then((response) => {
                    this.$router.push('/customerPlan/updateCustomerPlan')
                });
        },
        delCustomerPlan(id) {
