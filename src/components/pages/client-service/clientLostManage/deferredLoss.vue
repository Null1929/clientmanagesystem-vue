<template>
    <div>
        <table>
            ...
            <tr>
                <td>追加暂缓措施</td>
                <td><input type="text" v-model="catcheClientLost.tmpReprieve"></td>
            </tr>
            <tr>
...
export default {
    ...
    methods: {
        save() {
            ...
            httpRequest.post('/clientservice/clientLost/saveClientLost', {
                ...
                status: "暂缓流失",
                reprieve: this.catcheClientLost.reprieve + ' ' + this.catcheClientLost.tmpReprieve,
            })
                .then((response) => {
